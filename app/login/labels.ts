...
export const AUTH_LABEL_KEYS: StringKey[] = [
  "operator_name", "operator_name_optional", "operator_name_hint",
  "operator_email", "password_label", "login_title",
  "login_submit", "register_title", "register_submit", "auth_no_account",
